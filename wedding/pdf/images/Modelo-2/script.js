document.addEventListener("DOMContentLoaded", () => {
    ...
    const singlePackage = {
        ...
        priceQ: 369,
        priceUSD: 47,
        image: "/wedding/pdf/images/Modelo-2/media/0.png"
    };
...
const images = [
    "/wedding/pdf/images/Modelo-2/media/0.png",
    "/wedding/pdf/images/Modelo-2/media/1.png",
    "/wedding/pdf/images/Modelo-2/media/2.png",
    "/wedding/pdf/images/Modelo-2/media/3.png",
    "/wedding/pdf/images/Modelo-2/media/4.png",
];
...
//abrir invitacion
    function openInvitation() {
        window.open("/wedding/pdf/images/Modelo-2/modelo-honey.pdf", "_blank");
    }