    ...
    function showPackage(type) {
        ...
        let packages = {
            basic: {
                ...
                priceQ: 685,
                priceUSD: 87,
                image: "/celebraciones/web/Modelo-2/media/1.png"
            },
            premium: {
                title: "Incluye:",
                details: [
                ...
                priceQ: 789,
                priceUSD: 99,
                image: "/celebraciones/web/Modelo-2/media/0.png"
            }
        };
...
const images = [
    "/celebraciones/web/Modelo-2/media/0.png",
    "/celebraciones/web/Modelo-2/media/1.png",
    "/celebraciones/web/Modelo-2/media/2.png",
    "/celebraciones/web/Modelo-2/media/3.png",
    "/celebraciones/web/Modelo-2/media/4.png",
    "/celebraciones/web/Modelo-2/media/5.png",
];
...
//abrir invitacion
    function openInvitation() {
        window.open("https://lilys50th-and-fabulous.netlify.app/", "_blank");
    }