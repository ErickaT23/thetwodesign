document.addEventListener("DOMContentLoaded", () => {
    ...
    const singlePackage = {
        ...
        priceQ: 369,
        priceUSD: 47,
        image: "/celebraciones/pdf/Modelo-1/media/0.png"
    };
...
const images = [
    "/celebraciones/pdf/Modelo-1/media/0.png",
    "/celebraciones/pdf/Modelo-1/media/1.png",
    "/celebraciones/pdf/Modelo-1/media/2.png",
    "/celebraciones/pdf/Modelo-1/media/3.png",
];
...
//abrir invitacion
    function openInvitation() {
        window.open("/celebraciones/pdf/Modelo-1/Bautizo-sweet pink.pdf", "_blank");
    }
