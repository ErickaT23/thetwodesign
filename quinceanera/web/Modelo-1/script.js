    ...
    function showPackage(type) {
        ...
        let packages = {
            basic: {
                ...
                priceQ: 685,
                priceUSD: 87,
                image: "/quinceanera/web/Modelo-1/media/1.png"
            },
            premium: {
                title: "Incluye:",
                details: [
                ...
                priceQ: 789,
                priceUSD: 99,
                image: "/quinceanera/web/Modelo-1/media/0.png"
            }
        };
...
const images = [
    "/quinceanera/web/Modelo-1/media/0.png",
    "/quinceanera/web/Modelo-1/media/1.png",
    "/quinceanera/web/Modelo-1/media/2.png",
    "/quinceanera/web/Modelo-1/media/3.png",
    "/quinceanera/web/Modelo-1/media/4.png",
    "/quinceanera/web/Modelo-1/media/5.png",
];
...
//abrir invitacion
    function openInvitation() {
        window.open("https://misquince-alondra.netlify.app/?id=1", "_blank");
    }