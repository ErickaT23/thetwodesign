document.addEventListener("DOMContentLoaded", () => {
    ...
    const singlePackage = {
            details: [
                ...
                "- Frase especial o dedicatoria: Personaliza con un mensaje romántico, versículo o poema.",
                "- Diseño personalizado: Estilo elegante acorde a la temática del evento.",
                "- Formato compartible: Imagen lista para enviar por WhatsApp y redes sociales.",
                "- Opción de impresión: Pueden imprimirla si lo desean.",
            ],
        priceQ: 159,
        priceUSD: 20,
        image: "/celebraciones/imagen/modelo-3/media/0.png"
    };
...
const images = [
    "/celebraciones/imagen/modelo-3/media/0.png",
    "/celebraciones/imagen/modelo-3/media/1.png",
];
...
//abrir invitacion
    function openInvitation() {
        window.open("/celebraciones/imagen/modelo-3/Baby Shower Safari.png", "_blank");
    }