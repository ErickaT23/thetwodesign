    ...
    function showPackage(type) {
        ...
        let packages = {
            basic: {
                ...
                priceQ: 685,
                priceUSD: 87,
                image: "/wedding/web/Modelo-1/media/1.png"
            },
            premium: {
                title: "Incluye:",
                details: [
                ...
                priceQ: 789,
                priceUSD: 99,
                image: "/wedding/web/Modelo-1/media/0.png"
            }
        };
...
const images = [
    "/wedding/web/Modelo-1/media/0.png",
    "/wedding/web/Modelo-1/media/1.png",
    "/wedding/web/Modelo-1/media/2.png",
    "/wedding/web/Modelo-1/media/3.png",
    "/wedding/web/Modelo-1/media/4.png"
];
...
//abrir invitacion
    function openInvitation() {
        window.open("https://invitacionreal.netlify.app/", "_blank");
    }
