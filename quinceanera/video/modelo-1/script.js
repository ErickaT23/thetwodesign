document.addEventListener("DOMContentLoaded", () => {
    ...
    const singlePackage = {
            details: [
                ...
                "- Diseño y animación: Invitación en video con estilo único y elegante.",
                "- Música de fondo: Agrega un toque especial con la melodía que prefieras.",
                "- Formato compartible: Video listo para enviar por WhatsApp y redes sociales.",
                "- Link General: Enlace para compartir en redes sociales y mensajería."
            ],
        priceQ: 264,
        priceUSD: 33,
        image: "/quinceanera/video/modelo-1/media/0.png"
    };
...
const images = [
    "/quinceanera/video/modelo-1/media/0.png",
    "/quinceanera/video/modelo-1/media/1.png",
    "/quinceanera/video/modelo-1/media/2.png",
    "/quinceanera/video/modelo-1/media/3.png",
    "/quinceanera/video/modelo-1/media/4.png",
    "/quinceanera/video/modelo-1/media/5.png",
    "/quinceanera/video/modelo-1/media/6.png",
];
...
//abrir invitacion
    function openInvitation() {
        window.open("/quinceanera/video/modelo-1/modelo-mariposa.mp4", "_blank");
    }